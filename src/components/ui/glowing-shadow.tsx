    ...
    <>
      <style jsx>{`
        ...
        .glow-content:before {
          ...
          z-index: -1;
          background: rgba(248, 250, 252, 0.8) radial-gradient(
        ...
        .glow {
          ...
          border-radius: calc(var(--glow-radius) * 0.5px);
        }
        ...
        .glow-container:hover .glow-content {
          ...
          --text-color: white;
          box-shadow: 0 0 calc(var(--white-shadow) * 20px) calc(var(--white-shadow) * 3px) rgb(255 255 255 / 10%);
